...
describe('Final rank score', () => {

  describe('Test for finalScore > 80', () => {
  ...
  describe('Test for finalScore > 60 && < 80', () => {
  ...
  describe('Test for finalScore > 40 && < 60', () => {
  ...
  describe('Test for finalScore > 20 && < 40', () => {  
  ...
  describe('Test for finalScore < 20', () => {  
