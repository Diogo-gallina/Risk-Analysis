...
describe("Time of existence validate", () => {
  describe("Test for timeOfExistence <= 2 Yers", () => {
    test("Should be able to return 3 for time Of Existence less than 2 years", () => {
      const timeOfExistence = 1;
      const score =
        TimeOfExistenceValidate.calculateDateOfExistence(timeOfExistence);
      expect(score).toBe(3);
    });
  ...
  describe("Test for timeOfExistence > 2 && timeOfExistence <= 5", () => {
  ...
  describe("Test for timeOfExistence > 5 && timeOfExistence <= 9", () => {
  ...
  describe("Test for timeOfExistence > 9 Yers", () => {
